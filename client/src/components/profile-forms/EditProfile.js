...
const EditProfile = ({
  ...
  // get current users profile from state
  useEffect(() => {
    getCurrentUsersProfile();

    // make any changes to the state of the form data
    setFormData({
...
// map users profile to props from the state
...
export default connect(mapStateToProps, {
  createProfile,
  getCurrentUsersProfile,
})(withRouter(EditProfile)); // wrap component with 'withRouter' to allow history object to be used as a prop
